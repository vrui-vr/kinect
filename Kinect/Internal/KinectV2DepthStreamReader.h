...
class KinectV2DepthStreamReader
	...
	typedef Threads::FunctionCall<const RawImage&> RawImageReadyCallback; // Type for functions called when a new raw range-gated IR image is finished
	typedef Threads::FunctionCall<const FrameBuffer&> ImageReadyCallback; // Type for functions called when a new depth image has been decoded
	...
	RawImageReadyCallback* rawImageReadyCallback; // Function called whenever a raw range-gated IR image has been decompressed; this should be a reference, but can't be
