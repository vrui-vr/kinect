...
class Projector2:public ProjectorBase,public GLObject
	{
	/* Embedded classes: */
	public:
	...
	/* New methods: */
	Point unprojectPixel(unsigned int x,unsigned int y) const; // Unprojects a pixel from the current depth image into world space
