...
$(EXEDIR)/KinectUtil: PACKAGES += MYKINECT MYVIDEO MYGEOMETRY MYMATH MYIO MYUSB MYMISC
...
$(EXEDIR)/BackgroundViewer: PACKAGES += MYKINECT MYVRUI MYVIDEO MYGLGEOMETRY MYGLSUPPORT MYGEOMETRY MYMATH MYIO MYTHREADS MYMISC GL
