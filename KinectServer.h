...
class KinectServer
	...
	static void newFrameCallbackWrapper(Threads::EventDispatcher::IOEvent& event) // Wrapper function for above
		{
		static_cast<KinectServer*>(event.getUserData())->newFrameCallback();
		}
