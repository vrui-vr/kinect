...
void KinectClient::RemoteClientState::connect(void)
	...
	try
		...
		std::cout<<std::endl;
		#endif
		Kinect::MultiplexedFrameSource* source=Kinect::MultiplexedFrameSource::create(Comm::openTCPPipe(kinectServerHostName.c_str(),kinectServerPortId));
...
void KinectClient::frame(Collaboration::ProtocolClient::RemoteClientState* rcs)
	...
	if(myRcs==0)
		throw Misc::makeStdErr(__PRETTY_FUNCTION__,"Mismatching remote client state object type");
