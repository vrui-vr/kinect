...
class GridTool:public Vrui::Tool,public Vrui::Application::Tool<RawKinectViewer>
	...
	typedef Geometry::ComponentArray<double,2> DSize;
	private:
	...
	static Size gridSize; // Number of rows and columns in grid
	static DSize tileSize; // Size of each grid tile in world space units
	...
	static void setTileSize(const DSize& newTileSize);
