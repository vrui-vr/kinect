...
class DepthCorrectionTool:public Vrui::Tool,public Vrui::Application::Tool<RawKinectViewer>
	...
	unsigned int degree; // Degree of B-splines approximating the depth correction offsets
	Size numSegments; // Number of B-spline segments (horizontal and vertical) approximating the depth correction offsets
